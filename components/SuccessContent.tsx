      ...
      >
        ...
        <div className="space-y-4 mb-4 text-left">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Link
            href="/"
            className="flex items-center justify-center px-4 py-3 font-semibold bg-shop_dark_green text-white rounded-lg hover:bg-shop_dark_green/90 transition-all duration-300 shadow-md"
          >
